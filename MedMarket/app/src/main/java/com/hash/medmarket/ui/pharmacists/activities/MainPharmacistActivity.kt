...
class MainPharmacistActivity : AppCompatActivity(), PharmacistDrawerListener {

    private lateinit var binding: ActivityMainPharmacistBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMainPharmacistBinding.inflate(layoutInflater)
        setContentView(binding.root)


        val navView: NavigationView = binding.navView
        navController = findNavController(R.id.nav_host_fragment_content_main_pharmacist)

        val navInflater = navController.navInflater
        val graph = navInflater.inflate(R.navigation.pharmacist_navigation)
